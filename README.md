## Github Blog
- [https://jinmang2.github.io](https://jinmang2.github.io)
- 이 블로그는 [zzsza](https://github.com/zzsza/zzsza.github.io)님 블로그 테마를 기반으로 제작되었습니다
- 성윤님를 사용하고 싶으신 경우, issue 또는 메일([snugyun01@gmail.com](snugyun01@gmail.com))로 사용 요청을 해주세요. 이 블로그의 소스는 성윤님께서 피와 땀으로 만들었기 때문에 요청을 주시는 것이 예의라고 생각합니다 :)(사실 요청하신 분들에게 거절할 생각도 없다고 합니다.)
...
- 근데 tile-wide.png수정해도 안바뀌던데 왜 그럴까
